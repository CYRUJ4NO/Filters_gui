...
class CalculadorFiltrosRC(QMainWindow):
    def __init__(self):
        ...
        self.chk_fase.setChecked(False) # Desmarcado por defecto según tu última captura
    ...
    def plot(self):
        ...
        # Control dinámico de escala en base al Checkbox
        if self.chk_fase.isChecked():
            self.ax1.set_ylim(-60, 5) # Escala original para dar espacio a la fase
        else:
            self.ax1.set_ylim(-40, 5) # Nueva escala optimizada cuando no hay fase
