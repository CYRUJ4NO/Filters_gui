...
class CalculadorFiltrosRC(QMainWindow):
    def __init__(self):
        ...
        self.lbl_c1 = QLabel("Capacitancia (C):")
        ...
        self.combo_unit_c2 = QComboBox(); self.combo_unit_c2.addItems(["nF", "pF", "μF", "mF", "F"])
    ...
    def plot(self):
        ...
        if tipo == "Pasa Banda":
            ...
            # Etapa Pasa Alta (fc1) y Etapa Pasa Baja (fc2)
            fc1 = 1 / (2 * np.pi * R1 * C1)
            fc2 = 1 / (2 * np.pi * R2 * C2)
            ...
            # Función de transferencia aproximada para etapas en cascada con desacople
